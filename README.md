...
** NB: In the first year of each group, group composition is **not reliable** because not all individuals are directly recorded due to unhabituation. If you are interested in the early years of the group, please make sure to subset the composition as to not include the first year of observation on each group! **
